...
export {
  ...
  particleForceConfigSchema,
  particleSizeStopSchema,
  ...
  textGlowDirectionSchema,
  textGradientStopSchema,
  textMorphConfigSchema,
  textNodeSchema,
  textOutlineConfigSchema,
  textPathAlignmentSchema,
  textPathConfigSchema,
  textPathOrientationSchema,
  textPathSegmentSchema,
  textPathSpacingSchema,
