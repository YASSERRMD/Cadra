 ...
 * script produces and that gets committed to git) and validates all three
 * example documents against it directly with an independent JSON Schema
 * validator (ajv). This is a genuinely separate code path from `parseScene`,
